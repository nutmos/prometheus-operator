...
func (in *AWSSDConfig) DeepCopyInto(out *AWSSDConfig) {
	*out = *in
	if in.Region != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AWSSDConfig.
func (in *AWSSDConfig) DeepCopy() *AWSSDConfig {
	if in == nil {
		return nil
	}
	out := new(AWSSDConfig)
...
func (in *ScrapeConfigSpec) DeepCopyInto(out *ScrapeConfigSpec) {
	*out = *in
	...
	if in.AWSSDConfigs != nil {
		in, out := &in.AWSSDConfigs, &out.AWSSDConfigs
		*out = make([]AWSSDConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
